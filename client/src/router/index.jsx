...
export const seoConfig = {
  home: {
    ...
    path: 'https://charity4acourse.co.ke/'
  },
  about: {
    ...
    path: 'https://charity4acourse.co.ke/about'
  },
  events: {
    ...
    path: 'https://charity4acourse.co.ke/events'
  },
  gallery: {
    ...
    path: 'https://charity4acourse.co.ke/gallery'
  },
  galleryEvent: {
    ...
    path: 'https://charity4acourse.co.ke/gallery/:eventSlug'
  },
  news: {
    ...
    path: 'https://charity4acourse.co.ke/news'
  },
  contact: {
    ...
    path: 'https://charity4acourse.co.ke/contact'
  },
  support: {
    ...
    path: 'https://charity4acourse.co.ke/support'
  },
  bio: {
    ...
    path: 'https://charity4acourse.co.ke/bio'
  },
  notFound: {
    ...
    path: 'https://charity4acourse.co.ke/404'
  }
}
