...
export default function MissionVisionBanner({ 
  ...
  return (
    <section className='relative min-h-[500px] overflow-hidden bg-[#04211E] border-b border-white/5'>
      ...
      <div className={`relative z-10 mx-auto max-w-7xl px-4 md:px-6 py-8 md:py-16 flex flex-col ${isImageLeft ? 'md:flex-row' : 'md:flex-row-reverse'} items-stretch gap-6 md:gap-12 min-h-[500px]`}>
        ...
        <div className={`w-full md:w-[40%] flex flex-col justify-center ${isImageLeft ? 'md:pr-4' : 'md:pl-4'}`}>
          ...
          <div className="relative">
            <svg 
              className="absolute -top-2 -left-4 w-8 h-8 text-teal-400/20 fill-current"
              viewBox="0 0 24 24"
            >
            ...
            <p className='text-white/80 text-sm md:text-base leading-relaxed pl-6'>
              {info}
            </p>
          </div>
